...
varXAxis = {
    ...
    "delta_R_ll": "#Delta R_{ll} (Rad)",
    "delta_R_tt": "#Delta R_{#tau#tau} (Rad)",
    "delta_Eta_ll": "#Delta #eta_{ll} (Rad)",
    "delta_Eta_tt": "#Delta #eta_{#tau#tau} (Rad)",
    "delta_R_tt_ll": "#Delta R_{#tau#tau,ll} (Rad)",
